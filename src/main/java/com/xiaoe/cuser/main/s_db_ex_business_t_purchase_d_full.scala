...
/*
spark-submit  --class com.xiaoe.cuser.main.s_db_ex_business_t_purchase_d_full  --master yarn --deploy-mode cluster --driver-memory 2g  --executor-memory 1g --executor-cores 2   cuser_behaviors_daily_hive-1.0-SNAPSHOT.jar

 */
object s_db_ex_business_t_purchase_d_full {
